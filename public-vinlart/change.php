...
<div class="container mx-auto">
  ...
  <a href="sign_up.php" class="btn">
            <div style="position: relative; text-align: left; display: flex; flex-direction: column; align-items: left; justify-content: center; margin-left: 0.4rem;">
                <span data-key="login" class="darklight" style="text-align: left;">sign_up.</span>
        ...
        <a href="sign_up.php" class="btn">         
        <svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" class="tows" width="25" height="25" viewBox="0 0 24 24" data-name="Layer 1"><path d="m12 0a12 12 0 1 0 12 12 12.013 12.013 0 0 0 -12-12zm0 22a10 10 0 1 1 10-10 10.011 10.011 0 0 1 -10 10zm5-10a1 1 0 0 1 -1 1h-3v3a1 1 0 0 1 -2 0v-3h-3a1 1 0 0 1 0-2h3v-3a1 1 0 0 1 2 0v3h3a1 1 0 0 1 1 1z"></path></svg>
                </a>
        </span>
    </div>
   
    <div style="padding: 0px 4px; margin-top: 1rem" class="stories-title darklight dark-mode">
        
  <div class="post-info">
  <a href="login.php" class="btn">
            <div style="position: relative; text-align: left; display: flex; flex-direction: column; align-items: left; justify-content: center; margin-left: 0.4rem;">
                <span data-key="register" class="darklight dark-mode" style="text-align: left;">register</span>
                <div data-key="profile" style="font-size: 12px; color: gray; text-align: left;"></div>
            </div>
    </a>
        </div>
    ...
    <br>
    <?php if (!empty($cuentas_registradas)) : ?>
     <ul style="padding:0px;">
            <?php foreach ($cuentas_registradas as $usuario) : ?>
                <li>
                <div class="post-info">
            <div style="border: solid 0px; margin-left: 4px" class="post-img">
                <img style="object-fit: cover; border-radius: 50%; max-width: 45px; max-height: 45px; min-width: 45px; min-height: 45px;" src="perfiles/<?php
$clave = $usuario;
...
?></span>
        ...
        <span class="btn darklight dark-mode">
            <form method="post" style="display: inline;">
                        <input type="hidden" name="eliminar" value="<?php echo $usuario; ?>">
                        <button style="margin-left:6px; background-color: transparent; color:black; float: right; justify-content: center; transform: rotate(0deg); display: flex; padding: 2px; border-radius: 6px; margin-top: -19px; border:solid 0px white; font-size: 16px;" type="submit"><svg style="fill:red;" xmlns="http://www.w3.org/2000/svg" id="Outline" viewBox="0 0 24 24" width="19" height="19"><path d="M21,4H17.9A5.009,5.009,0,0,0,13,0H11A5.009,5.009,0,0,0,6.1,4H3A1,1,0,0,0,3,6H4V19a5.006,5.006,0,0,0,5,5h6a5.006,5.006,0,0,0,5-5V6h1a1,1,0,0,0,0-2ZM11,2h2a3.006,3.006,0,0,1,2.829,2H8.171A3.006,3.006,0,0,1,11,2Zm7,17a3,3,0,0,1-3,3H9a3,3,0,0,1-3-3V6H18Z"/><path d="M10,18a1,1,0,0,0,1-1V11a1,1,0,0,0-2,0v6A1,1,0,0,0,10,18Z"/><path d="M14,18a1,1,0,0,0,1-1V11a1,1,0,0,0-2,0v6A1,1,0,0,0,14,18Z"/></svg></button>
                    </form>
        <a href="?usuario=<?php echo $usuario; ?>"><button style="background-color: transparent; color:white; float: right; justify-content: center; transform: rotate(0deg); display: flex; padding: 2px; border-radius: 6px; margin-top: -19px; border:solid 0px #2196f3; font-size: 16px;" type="submit"><?php if($usuario == $d){
        echo '<svg class="tows" xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1" viewBox="0 0 24 24" width="19" height="19"><path d="m12,0C5.383,0,0,5.383,0,12s5.383,12,12,12,12-5.383,12-12S18.617,0,12,0Zm-.091,15.419c-.387.387-.896.58-1.407.58s-1.025-.195-1.416-.585l-2.782-2.696,1.393-1.437,2.793,2.707,5.809-5.701,1.404,1.425-5.793,5.707Z"/></svg>';
    }else{
        echo '<svg class="tows" xmlns="http://www.w3.org/2000/svg" id="Outline" viewBox="0 0 24 24" width="19" height="19"><path d="M12,0A12,12,0,1,0,24,12,12,12,0,0,0,12,0Zm0,22A10,10,0,1,1,22,12,10,10,0,0,1,12,22Z"/></svg>';
    }?></button></a>
...
<script>
  function togglePasswordVisibility() {
    ...
    <div style="border-bottom:1px #80808000 solid;" class="tabs_bottom tows">
        <div class="tab2 tows" style="border-bottom: 3px solid #03a9f400;" onclick="openTab('tab2')"><a href="home.php"><svg class="towse" viewBox="0 0 48 48" width="20" height="20" fill="transparent"><path stroke-width="4" d="M 23.951 2 C 23.631 2.011 23.323 2.124 23.072 2.322 L 8.859 13.52 C 7.055 14.941 6 17.114 6 19.41 L 6 38.5 C 6 39.864 7.136 41 8.5 41 L 18.5 41 C 19.864 41 21 39.864 21 38.5 L 21 28.5 C 21 28.205 21.205 28 21.5 28 L 26.5 28 C 26.795 28 27 28.205 27 28.5 L 27 38.5 C 27 39.864 28.136 41 29.5 41 L 39.5 41 C 40.864 41 42 39.864 42 38.5 L 42 19.41 C 42 17.114 40.945 14.941 39.141 13.52 L 24.928 2.322 C 24.65 2.103 24.304 1.989 23.951 2 Z"></path></svg></a></div>
